...
DrawingBoard.Board.prototype = {
	...
	draw: function() {
		...
		if (this.isDrawing) {
			...
			this.ctx.beginPath();
			this.ctx.moveTo(Math.round(currentMid.x), Math.round(currentMid.y));
			this.ctx.lineTo(Math.round(this.coords.oldMid.x), Math.round(this.coords.oldMid.y));
			this.ctx.filter = "url(#crisp)";
